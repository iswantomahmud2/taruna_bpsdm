    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-4">
                ...
                <div class='form-group'>Pegawai Ijin
                    <input type="text" class="form-control" name="ijin" id="ijin" placeholder="Jumlah Pegawai Sakit/Ijin, dan lainnya" />
            ...
            <div class="col-md-4">
                ...
                <div class='form-group'>Pegawai Dirawat
                    <input type="text" class="form-control" name="dirawat" id="dirawat" placeholder="Jumlah Pegawai Dirawat" />
